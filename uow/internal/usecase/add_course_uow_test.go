...
import (
	...
	"github.com/drawiin/go-expert/uow/internal/db"
	"github.com/drawiin/go-expert/uow/internal/repository"
	"github.com/drawiin/go-expert/uow/pkg/uow"
...
func TestAddCourseUow(t *testing.T) {
	...
	input := InputUseCase{
		...
		CourseName:       "Course 1",
		CourseCategoryID: 2, // The test will fail but all changes made will be rolled back using the UOW
	}
